  ...
  return (
    <div className="p-4 md:p-6 space-y-6 max-w-[1400px] mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <KPICard title="Sebaran per Provinsi" value={provinsiData.length} icon={Globe} gradient="blue" subtitle="Provinsi unik" />
        ...
        <KPICard title="Sebaran per Pulau" value={pulauData.length} icon={Layers} gradient="orange" subtitle="Pulau/Wilayah" />
      </div>
